...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main.py discover           # Find computer's IP for IWP device setup
  python main.py server             # Run UDP server only
  python main.py visualize          # Run visualizer with integrated server
  python main.py visualize --port 7200  # Use custom port
